...
export ADDITIONAL_CFLAGS = -I$(THEOS_PROJECT_DIR)/Tweaks/RemoteLog -I$(THEOS_PROJECT_DIR)/Tweaks -Wno-error=incompatible-pointer-types
ifneq ($(JAILBROKEN),1)
...
$(TWEAK_NAME)_CFLAGS = -fobjc-arc -DTWEAK_VERSION="$(PACKAGE_VERSION)" -Wno-module-import-in-extern-c -Wno-error=incompatible-pointer-types
...
ifneq ($(JAILBROKEN),1)
SUBPROJECTS += Tweaks/Alderis Tweaks/FLEXing/libflex Tweaks/iSponsorBlock Tweaks/YouGroupSettings Tweaks/YTABConfig Tweaks/YTUHD Tweaks/DontEatMyContent Tweaks/YTVideoOverlay Tweaks/YouMute Tweaks/YouQuality Tweaks/YTClassicVideoQuality Tweaks/NoYTPremium Tweaks/YouTube-X Tweaks/YouSpeed
